...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      // includeAssets: ["**/*"],
      includeAssets: [
        "https://res.cloudinary.com/dpb2bimpi/image/upload/v1749820293/DeWatermark.ai_1749820251938_e3hvnf.jpg",
        "src/assets/img/*.png",
        "src/assets/img/*.jepg",
        "src/assets/img/*.webp",
        "favicon.ico",
      ...
      manifest: {
        ...
        start_url: ".",
        id: ".",
        short_name: "Automotive Spare Parts Platform",
        name: "Automotive Spare Parts Platform | Admin Dashboard",
        description:
          "Automotive Spare Parts Platform",
        icons: [
          {
            src: "favicon.ico",
            sizes: "48x48",
