...
export const nissanModels = [
  {
    id: 1,
    name: "NISSAN 350Z",
    image: "https://boodmo.com/media/cache/vehicle_model/images/model/07d2689.webp",
    years: "01.2003 - 12.2009",
    link: "/vehicles/nissan-330/350_z-12812/",
    modifications: [
      {
        generation: "350Z 01.2003 - 12.2009",
        options: [
          "3.5L/Petrol"
        ]
      }
  ...
  },
  {
    id: 2,
    name: "NISSAN 370Z",
    image: "https://boodmo.com/media/cache/vehicle_model/images/model/86b2d2a.webp",
    years: "01.2010 - 01.2014",
    link: "/vehicles/nissan-330/370z-12800/",
    modifications: [
      {
        generation: "370Z 01.2010 - 01.2014",
        options: [
          "3.6L/Petrol",
          "3.6L AT/Petrol"
        ]
  ...
  },  
  {
    id: 3,
    name: "NISSAN EVALIA",
    image: "https://boodmo.com/media/cache/vehicle_model/images/model/e025bc6.webp",
    years: "08.2012 - 06.2015",
    link: "/vehicles/nissan-330/evalia-11346/",
    modifications: [
      {
        generation: "EVALIA 08.2012 - 06.2015",
        options: [
          "1.5L/Diesel/86h.p./BS4",
          "1.5L XE/Diesel/BS4",
          "1.5L XL/Diesel/BS4",
          "1.5L XV/Diesel/BS4",
          "1.5L XV(O)/Diesel/BS4"
        ]
      }
    ]
  },
  
  {
    id: 4,
    name: "NISSAN GT-R",
    image: "https://boodmo.com/media/cache/vehicle_model/images/model/8cd5945.webp",
    years: "12.2008 - 08.2025",
    link: "/vehicles/nissan-330/gt_r-12094/",
    modifications: [
      {
        generation: "GT-R (R35) (2008) 12.2008 - 08.2025",
        options: [
          "3.8L V6/Petrol"
        ]
      }
  ...
  },
  {
    id: 5,
    name: "NISSAN KICKS",
    image: "https://boodmo.com/media/cache/vehicle_model/images/model/aaf63c0.webp",
    years: "12.2018 - 04.2023",
    link: "/vehicles/nissan-330/kick-12304/",
    modifications: [
      {
        generation: "KICKS 12.2018 - 04.2023",
        options: [
          "1.3L XV/Petrol/BS6",
          "1.3L XV AT/Petrol/BS6",
          "1.3L XV PREMIUM/Petrol/BS6",
          "1.3L XV PREMIUM AT/Petrol/BS6",
          "1.3L XV PREMIUM(O)/Petrol/BS6",
          "1.5L XL/Diesel/BS4",
          "1.5L XL/Petrol/BS4",
          "1.5L XV/Petrol/BS4",
          "1.5L XV/Diesel/BS4",
          "1.5L XV PREMIUM/Diesel/BS4",
          "1.5L XV PREMIUM(O)/Diesel/BS4"
        ]
      }
    ]
  },
  {
    id: 6,
    name: "NISSAN MAGNITE",
    image: "https://boodmo.com/media/cache/vehicle_model/images/model/7c55db7.webp",
    years: "12.2020 - now",
    link: "/vehicles/nissan-330/magnite-12388/",
    modifications: [
      {
        generation: "MAGNITE 12.2020 - 10.2024",
        options: [
          "1.0L/Petrol/72h.p./BS6",
          "1.0L/Petrol/100h.p./BS6",
          "1.0L AT/Petrol/BS6"
        ]
      },
      {
        generation: "MAGNITE F/L 10.2024 - now",
        options: [
          "1.0L/Petrol/72h.p./BS6.2",
          "1.0L/Petrol/100h.p./BS6.2",
          "1.0L AMT/Petrol/BS6.2",
          "1.0L AT/Petrol/BS6.2"
        ]
      }
    ]
  },
...
export const Nissan = () => {
  const link = getOriPartsLink(36, "NISSAN");

  const [filter, setFilter] = useState("");
  const [categoryFilter, setCategoryFilter] = useState("");

  // Use exported models
  const models = nissanModels;
