...
export const ashokLaylandModels = [
  {
    id: 1,
    name: "ASHOK LEYLAND BADA DOST",
    image: "https://boodmo.com/media/cache/vehicle_model/images/model/d7dad34.webp",
    years: "09.2020 - now",
    link: "/vehicles/ashokleyland-21/bada_dost-12922/",
    modifications: [
      {
        generation: "BADA DOST 09.2020 - now",
        options: [
          "BADA DOST/Diesel/BS6"
        ]
      }
    ]
  },
  
  {
    ...
    image: "https://boodmo.com/media/cache/vehicle_model/images/model/3f008cb.webp",
    years: "09.2011 - now",
    link: "/vehicles/ashokleyland-21/dost-11971/",
    modifications: [
      {
        generation: "DOST 09.2011 - now",
        options: [
          "1.5L/Diesel"
        ]
      }
  ...
  },
  {
    ...
    image: "https://boodmo.com/media/cache/vehicle_model/images/model/ac331a8.webp",
    years: "10.2013 - 05.2015",
    link: "/vehicles/ashokleyland-21/stile-11895/",
    modifications: [
      {
        generation: "STILE 10.2013 - 05.2015",
        options: [
          "1.5L/Diesel"
        ]
      }
...
export const AshokLayland = () => {
  const link = getOriPartsLink(76, "ASHOK_LAYLAND");

  const [filter, setFilter] = useState("");
  const [categoryFilter, setCategoryFilter] = useState("");

  // Use exported models
  const models = ashokLaylandModels;
  ...
  return (
    <section className="min-h-screen py-6">
      ...
      {/* ---------ashok layland parts and accessories------------- */}
