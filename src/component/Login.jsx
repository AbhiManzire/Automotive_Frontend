      ...
      <div className="flex flex-col md:flex-row w-full max-w-5xl overflow-hidden rounded-xl shadow-2xl bg-white">
        ...
        <div className="md:w-1/2 h-60 md:h-auto relative" data-aos="fade-right">
          ...
          <div className="absolute bottom-6 left-6 text-white">
            ...
            <p className="text-sm text-gray-200 mt-2">Sign in to access your dashboard</p>
          </div>
        </div>

        {/* Right Form Section */}
        <main className="md:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-white" data-aos="fade-left">
          <div className="w-full max-w-md">
            <h1 className="mb-6 text-3xl font-bold text-primary-600">Login</h1>
            ...
            <form className="space-y-4" onSubmit={handleLogin}>
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <a href="/signup" className="text-sm text-primary-600 hover:underline">
                  Create account
                </a>
              </div>
