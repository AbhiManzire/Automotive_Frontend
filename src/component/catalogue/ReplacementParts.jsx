...
const replacementPartsData = [
  ...
  },
  {
    ...
    link: "/catalog/windscreen_cleaning_system/",
  },
  {
  ...
  },
  {
    ...
    img: "https://boodmo.com/media/images/categories/e39dc1a.svg",
    link: "/catalog/engine_cooling_system/",
  },
  {
    name: "Exhaust System",
    img: "https://boodmo.com/media/images/categories/83cd783.svg",
    link: "/catalog/exhaust_system/",
  },
  {
    name: "Air Conditioning",
    img: "https://boodmo.com/media/images/categories/10f1952.svg",
    link: "/catalog/air_conditioning/",
  },
  {
    name: "Fuel Supply System",
    img: "https://boodmo.com/media/images/categories/457f4a4.svg",
    link: "/catalog/fuel_supply_system/",
  },
  {
    name: "Gaskets and Sealing Rings",
    img: "https://boodmo.com/media/images/categories/38d5de9.svg",
    link: "/catalog/gaskets_and_sealing_rings/",
  },
  {
    name: "Ignition and Glowplug System",
    img: "https://boodmo.com/media/images/categories/bfcf2c1.svg",
    link: "/catalog/ignition_and_glowplug_system/",
  },
  {
    name: "Interior and Comfort",
    img: "https://boodmo.com/media/images/categories/7e1a432.svg",
    link: "/catalog/interior_and_comfort/",
  },
  {
    name: "Body",
  ...
  },
  {
    ...
    img: "https://boodmo.com/media/images/categories/eeab7a3.svg",
    link: "/catalog/pipes_and_hoses/",
  },
  {
    name: "Repair Kits",
    img: "https://boodmo.com/media/images/categories/38427d6.svg",
    link: "/catalog/repair_kits/",
  },
  {
    name: "Sensors Relays and Control Units",
    img: "https://boodmo.com/media/images/categories/878a84e.svg",
    link: "/catalog/sensors_relays_control_units/",
  },
  {
    name: "Steering",
    img: "https://boodmo.com/media/images/categories/15cfbae.svg",
    link: "/catalog/steering/",
  },
  {
    name: "Suspension and Arms",
    img: "https://boodmo.com/media/images/categories/9bcc0da.svg",
    link: "/catalog/suspension_and_arms/",
  },
  {
    name: "Towbar Parts",
    img: "https://boodmo.com/media/images/categories/95660dc.svg",
    link: "/catalog/towbar_parts/",
  },
  {
    name: "Transmission",
    img: "https://boodmo.com/media/images/categories/5924137.svg",
    link: "/catalog/transmission/",
  },
  {
    name: "Trims",
  ...
  },
  {
    ...
    img: "https://boodmo.com/media/images/categories/b1b2c08.svg",
    link: "/catalog/tyres_and_alloys/",
  },
  {
    name: "Universal",
    img: "https://boodmo.com/media/images/categories/8c5ddeb.svg",
    link: "/catalog/universal/",
  },
  {
    name: "Wheels",
  ...
  },
  {
    ...
    img: "https://boodmo.com/media/images/categories/51eb913.svg",
    link: "/catalog/belts_chains_rollers/",
  },
];
    ...
    <section className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        {filteredParts.map((part, index) => (
          <div
            key={index}
            onClick={() => handleClick(part.link)}
            className="flex flex-col items-center bg-white shadow hover:shadow-lg rounded-xl p-4 cursor-pointer transition-transform transform hover:scale-105"
          >
            <img
              src={part.img}
              alt={part.name}
