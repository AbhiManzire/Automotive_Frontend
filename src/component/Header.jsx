      ...
      <div className="flex justify-between items-center">
          ...
          {!isHomePage && (
            <div className="flex bg-gray-100 rounded-lg overflow-hidden shadow-sm text-sm w-[450px] md:w-[600px]">
              ...
              <button className="bg-sky-500 text-white px-5 flex items-center justify-center">
                <FaSearch className="text-lg md:text-sm" />
              </button>
            </div>
          )}
        </div>
        ...
        <div className="flex items-center gap-6 text-gray-700 font-medium">
          ...
          <div className="flex items-center gap-1">
            <MdAccountCircle className="text-sky-500 text-lg" />
            <select
          ...
          <button onClick={goToCart} className="hover:text-blue-700 hover:scale-110">
            <FaShoppingCart className="text-blue-900 text-lg" />
          </button>
          ...
          >
            ...
            <button 
              ...
              className="border-solid bg-sky-400 text-white px-6 py-2 rounded hover:bg-sky-500"
            >
              Login
            </button>
          )}
