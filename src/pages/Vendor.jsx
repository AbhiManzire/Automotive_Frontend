...
const Vendors = () => {
  ...
  return (
    <>
      <PageTitle>{t("VendorPageTitle")}</PageTitle>
      <MainDrawer>
        <VendorDrawer />
      </MainDrawer>
      <AnimatedContent>
          ...
          <Table>
            <TableHeader>
              <tr>
                ...
                <TableCell>{t("Status Action")}</TableCell>

                <TableCell>{t("Vendor Online ")}</TableCell>
                <TableCell className="text-center">{t("Actions ")}</TableCell>
              </tr>
            </TableHeader>
            <VendorTable vendors={dataTable} lang={lang} />
          </Table>
          <TableFooter>
            <Pagination
