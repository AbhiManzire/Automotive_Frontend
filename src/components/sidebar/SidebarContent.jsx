...
console.log("Expecting: 'banners' ->", accessList.includes("banners"));
  ...
  return (
    <div className="py-4 text-gray-500 dark:text-gray-400">
      <a className=" text-gray-900 dark:text-gray-200" href="/dashboard">
        {mode === "dark" ? (
          <img src={"https://res.cloudinary.com/dpb2bimpi/image/upload/v1749878535/logo_rbk3bk.png"} alt="Automotive Spare Parts" width="135" className="pl-6" />
        ) : (
          <img src={"https://res.cloudinary.com/dpb2bimpi/image/upload/v1749878535/logo_rbk3bk.png"} alt="Automotive Spare Parts" width="135" className="pl-6" />
        )}
      </a>
